				  ...
				  <div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							...
							<div class="col-sm-2">
								<a href="{{route('admin.addusers')}}"><button type="button" class="btn btn-primary add-new" style="float:right"><i class="fa fa-plus"></i> Add New</button></a>
							</div>
						</div>
						<br>
					</div>
						...
						<div class="card flex-fill">
							<table class="table table-hover my-0">
								...
								<tr>
									...
									<td>{{$user['email']}}</td>
									<td>
										<a href="{{url('admin/edit/'.$user->id)}}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
										<a href="{{url('admin/delete/'.$user->id)}}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
									</td>
									</tr>
									@endforeach
								</tbody>
